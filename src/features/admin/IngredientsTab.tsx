  ...
  return (
    <div>
      <PageHeader
        ...
        action={
          <Btn variant="primary" onClick={() => setShowAdd((prev) => !prev)}>
            {showAdd ? '취소' : '+ 성분 추가'}
          </Btn>
        }
      />
      {showAdd && (
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 12, color: '#64748b' }}>EWG 등급</span>
          </div>
            ...
            {filtered.map((i, idx) => (
              ...
              >
                ...
                <td style={{ padding: '12px 16px', textAlign: 'right' }}>
                  <Btn
                    variant="danger"
                    onClick={() => deleteIngredientHandler(i.ingredientId)}
                  >
                    삭제
                  </Btn>
                </td>
