...
export function OnboardingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <div className="flex w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl flex-col items-center justify-center gap-4">
        <p className="text-[#FEFEFE] text-4xl">먼저, 어떻게 불러드릴까요?</p>

        <form
          onSubmit={handleSubmit}
          className="flex w-full flex-col text-[#FEFEFE] gap-10 mt-10 text-left"
        >
