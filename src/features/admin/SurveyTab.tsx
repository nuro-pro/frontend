    ...
    setSurvey((prev) =>
      prev.map((q) =>
        q.questionId === questionId
          ? { ...q, options: q.options.filter((a) => a.answerId !== answerId) }
          : q,
      ),
    )
  ...
  return (
    <div>
      <PageHeader
        ...
        action={
          <Btn variant="primary" onClick={() => setShowAddQuestion(true)}>
            + 문항 추가
          </Btn>
        }
      />
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <input
              ...
              style={inputStyle}
            />
            <Btn variant="primary" onClick={addQuestion}>
              저장
            </Btn>
            <Btn
              variant="ghost"
          ...
          <Card key={q.questionId}>
            ...
            >
              ...
              >
                ...
                <span
                  style={{ fontSize: 15, fontWeight: 500, lineHeight: 1.5 }}
                >
                  {q.question}
                </span>
              </div>
              <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                <Btn
                  ...
                  onClick={() =>
                    setExpandedId(
                      expandedId === q.questionId ? null : q.questionId,
                    )
                  }
                >
              ...
              >
                ...
                >
                  {q.options.map((a) => (
                    ...
                    >
                      ...
                      <Btn
                        variant="danger"
                        onClick={() => deleteAnswer(q.questionId, a.answerId)}
                      >
                        삭제
                      </Btn>
                    </div>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === 'Enter' && addAnswer(q.questionId)
                    }
                    placeholder="선택지 추가"
                  ...
                  <Btn
                    variant="primary"
                    onClick={() => addAnswer(q.questionId)}
                  >
                    추가
                  </Btn>
                </div>
